...
def _new_site(db_name, site, db_root_username=None, db_root_password=None,
	...
	try:
		...
		install_db(root_login=db_root_username, root_password=db_root_password,
		...
		_drop_site(site, db_root_username, db_root_password, force=True)
